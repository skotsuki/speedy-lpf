...
! INTEGER :: nbv                                          ! KK
  ...
  INTEGER :: ierr
  namelist/letkf_param/ sigma_obs,nbv,pymdh,ymdh,logic_wout,logic_wsth,logic_wint,dastype,resample_m,type_pfmtx,type_relax,alph_relax,fgt_factor,gamma_gmpf
